              ...
              while ($row = mysqli_fetch_array($result)) { ?>
                ...
                <tbody>
                  ...
                  if ($curr_date == $todays_date) {
                    ...
                    ?>
                    <td>
                      <div class='text-center'><span class="label label-inverse">
                      ...
                      <div class='text-center'><a
                          href='actions/delete-attendance.php?id=<?php echo $row['user_id']; ?>'><button
                            class='btn btn-danger'>Check Out <i class='icon icon-time'></i></button> </a></div>
                    </td>
                    ...
                    <td>
                      <div class='text-center'><a
                          href='actions/check-attendance.php?id=<?php echo $row['user_id']; ?>'><button
                            class='btn btn-info'>Check In <i class='icon icon-map-marker'></i></button> </a></div>
                    </td>
