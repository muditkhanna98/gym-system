          ...
          while ($row = mysqli_fetch_array($result)) { ?>
            ...
            <?php if ($row['reminder'] == '1') { ?>
              ...
              <div class="alert alert-danger" role="alert">
                ...
                <p>This is to notify you that your current membership program is going to expire soon. Please clear up your
                  payments before your due dates. <br>IT IS IMPORTANT THAT YOU CLEAR YOUR DUES ON TIME IN ORDER TO AVOID
